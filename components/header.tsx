...
const Header = ({ userId }: HeaderProps) => {
  ...
  return (
    <header
      className={cn(
        "sticky w-full z-50 transition bg-transparent",
        isScrolled && " left-0 top-0 bg-white dark:bg-black shadow-lg"
      )}
    >
      <Container>
        <div className="relative px-4 sm:p-6 lg:px-12 flex items-center h-16">
          <Link
            href={"/"}
            className="text-lg uppercase flex gap-x-2 font-bold text-neutral-700 dark:text-white md:text-xl"
          >
